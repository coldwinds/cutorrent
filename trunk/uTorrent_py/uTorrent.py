...
#	Copyright (C) 2006 Rob Crowther <weilawei@gmail.com>
#
...
def main():
  uTorrent_handle = uTorrent(port='8080', username='admin', password='admin')
  torrents = uTorrent_handle.webui_ls()
  for t in torrents:
    name = t[UT_TORRENT_PROP_NAME]
    eta = t[UT_TORRENT_STAT_ETA]
    speed = t[UT_TORRENT_STAT_SPEED_DOWN] / 1000.0
    print "%s: %s (%s)" % (name, eta, speed) 
